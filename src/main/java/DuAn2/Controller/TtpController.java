...
public class TtpController {
	...
	public String ttp(ModelMap model) {
		...
		List<Room> l = (List<Room>) ittp.findAllOrderByMaDesc(pageable);
		activemenu(model);
		vitrihientai = 1;
		...
		model.addAttribute("titlepage", "Room information");
		return "ttp";
	}

	@RequestMapping("/timttp")
	public String timttp(ModelMap model, @ModelAttribute("phong") Room phong, HttpServletRequest httpServletRequest) {
		activemenu(model);
		PageRequest pageable = PageRequest.of(0, 5);
		String data = httpServletRequest.getParameter("data");
		List<Room> ltim;
		ltim = (List<Room>) quanlyphongService.TimMaPhong(Integer.parseInt(data), pageable);
	...
	public String ttppage(ModelMap model, @RequestParam("page") int page, @ModelAttribute("phong") Room phong) {
		activemenu(model);
	...
	public String ttppagetim(ModelMap model, @RequestParam("page") int page, @ModelAttribute("phong") Room phong, HttpServletRequest httpServletRequest) {
		activemenu(model);
