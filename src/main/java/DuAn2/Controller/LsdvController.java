...
import DuAn2.Model.ServiceMenu;
...
public class LsdvController {
	...
	public String lsdv(ModelMap model) {
		...
		List<ServiceMenu> l = (List<ServiceMenu>) ilsdv.findAllOrderByMaDesc(pageable);
	...
	public String timlsdtp(ModelMap model, @RequestParam("data") String data) {
		...
		PageRequest pageable = PageRequest.of(0, 10);
		List<ServiceMenu> ltim;
		ltim = (List<ServiceMenu>) ilsdv.timlsdv(data1, data2, data, datefind, pageable);
		vitrihientai = 1;
